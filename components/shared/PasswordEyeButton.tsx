...
interface IPasswordEyeButtonProps {
  isPasswordShow: boolean;
  handlePasswordShow: () => void;
}

const EyeIcon = ({ isPasswordShow }: { isPasswordShow: boolean }) => (
  <svg
    aria-hidden="true"
    focusable="false"
    data-prefix={isPasswordShow ? "far" : "fas"}
    data-icon={isPasswordShow ? "eye" : "eye-slash"}
    role="img"
...
const PasswordEyeButton: FC<IPasswordEyeButtonProps> = ({
  isPasswordShow,
  handlePasswordShow,
}) => {
  ...
  return (
    ...
    >
      ...
      >
        <EyeIcon isPasswordShow={isPasswordShow} />
      </Box>
    </Button>
  );
};
